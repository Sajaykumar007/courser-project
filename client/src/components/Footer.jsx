    ...
    <>
      <footer className="relative overflow-hidden bg-slate-950 text-white">
        ...
        {/* =====================================================
            ...
            (Replace the src with your own video if needed)
        ====================================================== */}
        <video
          autoPlay
          muted
        ...
        {/* =====================================================
            FOOTER CONTENT (z-10 to sit above the video)
        ====================================================== */}
        <div className="relative z-10 mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-7 md:grid-cols-3 md:items-center">
            ...
            <div className="group animate-[footerUp_.6s_ease-out]">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-xl font-extrabold tracking-tight">Courser</h2>
                  <p className="text-[11px] text-slate-400">Transforming Learners into Creators</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-2 animate-[footerUp_.7s_ease-out]">
              <a href="tel:+917706037060" className="group flex items-center gap-3 text-sm text-slate-300 transition-all duration-300 hover:translate-x-1 hover:text-emerald-400">
                <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-white/5 text-sm transition-all group-hover:bg-emerald-500/10">📞</span>
                <span>+91 77060 37060</span>
              </a>
              <a href="mailto:hi@courser.in" className="group flex items-center gap-3 text-sm text-slate-300 transition-all duration-300 hover:translate-x-1 hover:text-emerald-400">
                <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-white/5 text-sm transition-all group-hover:bg-emerald-500/10">✉️</span>
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="animate-[footerUp_.8s_ease-out]">
              <h3 className="mb-3 text-sm font-bold text-white">Popular Courses</h3>
              <ul className="space-y-2">
                {popularCourses.map((course, index) => (
                  <li key={index} className="group flex cursor-pointer items-center gap-2 text-xs text-slate-400 transition-all duration-300 hover:translate-x-1 hover:text-emerald-400">
                    <span className="text-emerald-500 transition-transform duration-300 group-hover:translate-x-1">→</span>
                    {course}
                  </li>
                ))}
              </ul>
            ...
            <div className="animate-[footerUp_.9s_ease-out]">
              <h3 className="mb-3 text-sm font-bold text-white">Support</h3>
              <ul className="space-y-2">
            ...
            <div className="animate-[footerUp_1s_ease-out]">
              <h3 className="mb-3 text-sm font-bold text-white">Our Centers</h3>
              <ul className="space-y-2">
                {centers.map((center, index) => (
                  ...
                  >
                    ...
                    <span className="ml-auto opacity-50 transition-all group-hover:scale-110 group-hover:opacity-100">📍</span>
                  </li>
                ))}
              </ul>
            </div>
            ...
            <div className="animate-[footerUp_1.1s_ease-out]">
              <h3 className="mb-3 text-sm font-bold text-white">Stay Updated</h3>
              <p className="mb-3 text-xs text-slate-400">Get course updates & offers</p>
              <form onSubmit={handleSubscribe} className="flex overflow-hidden rounded-xl border border-white/10 bg-white/5 transition-all duration-300 focus-within:border-emerald-500/50 focus-within:ring-2 focus-within:ring-emerald-500/10">
                <input
                  type="email"
              ...
              {subscribeStatus.message && (
                <p className={`mt-2 rounded-lg px-3 py-2 text-[11px] animate-[messageIn_.3s_ease-out] ${subscribeStatus.type === 'success' ? 'bg-emerald-500/10 text-emerald-400' : 'bg-red-500/10 text-red-400'}`}>
                  {subscribeStatus.message}
                </p>
              )}
            </div>
          ...
          <div className="my-7 flex items-center gap-4">
            ...
            <span className="text-sm text-emerald-500 animate-pulse">✦</span>
          ...
          <div className="flex flex-col gap-4 text-center sm:flex-row sm:items-center sm:justify-between sm:text-left">
            <p className="text-[10px] text-slate-500 sm:text-xs">
              © {currentYear} <span className="font-bold text-emerald-400">COURSER™</span> | Bangalore, India | All Rights Reserved
            </p>
        ...
        >
          ...
          >
            ...
            <div className="bg-gradient-to-r from-emerald-700 to-green-600 px-5 py-5 text-white">
              <h2 className="text-xl font-extrabold">{currentLocation.name}</h2>
              <p className="mt-1 text-xs text-emerald-50">📍 {currentLocation.address}</p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3 p-4">
              <button type="button" onClick={handleDirections} className="rounded-xl bg-emerald-600 px-4 py-3 text-xs font-bold text-white transition-all duration-300 hover:-translate-y-1 hover:bg-emerald-500 hover:shadow-lg hover:shadow-emerald-500/20">
                🗺️ Get Directions
              </button>
              <button type="button" onClick={handleCall} className="rounded-xl bg-slate-900 px-4 py-3 text-xs font-bold text-white transition-all duration-300 hover:-translate-y-1 hover:bg-slate-800 hover:shadow-lg">
                📞 Call Us
              </button>
            </div>
            ...
            <div className="grid gap-3 border-t border-slate-100 bg-slate-50 p-4 sm:grid-cols-2">
              <div className="flex items-center gap-3 rounded-xl bg-white p-3 shadow-sm">
                ...
                <div>
                  <strong className="block text-xs text-slate-800">Working Hours</strong>
                  <p className="mt-0.5 text-[11px] text-slate-500">Mon - Sat: 9:00 AM - 7:00 PM</p>
                </div>
              </div>
              <div className="flex items-center gap-3 rounded-xl bg-white p-3 shadow-sm">
                <span className="text-lg">📞</span>
                <div>
                  <strong className="block text-xs text-slate-800">Contact</strong>
                  <p className="mt-0.5 text-[11px] text-slate-500">+91 77060 37060</p>
                </div>
              </div>
            </div>
          </div>
